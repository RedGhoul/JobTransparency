        ...
        public async Task<IActionResult> OnPostAsync(string returnUrl = null)
        {
            ...
            if (ModelState.IsValid)
            {
                ...
                if (result.Succeeded)
                {
                    ...
                    await _emailSender.SendEmailAsync(Input.Email, "Confirm your email For Jobtransparency.com",
                        $"Hello from Jobtransparency !" + Environment.NewLine +
                        $"Please confirm your account by clicking:" + Environment.NewLine +
                        callbackUrl);
